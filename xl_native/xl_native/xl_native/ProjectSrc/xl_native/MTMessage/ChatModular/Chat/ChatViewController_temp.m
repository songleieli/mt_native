...
#import "TCUtil.h"
#import "THelper.h"
//#import "ChatViewController_temp+video.h"
//#import "VideoCallManager.h"

// MLeaksFinder 会对这个类误报，这里需要关闭一下
@implementation ChatViewController_temp (Leak)
...
@interface ChatViewController_temp () <TUIChatControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIDocumentPickerDelegate>
@property (nonatomic, strong) TUIChatController *chat;
@end

@implementation ChatViewController_temp
