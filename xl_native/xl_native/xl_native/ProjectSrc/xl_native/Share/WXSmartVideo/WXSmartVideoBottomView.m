...
-(void)setEnableVideoRecord:(BOOL)enableVideoRecord{
    ...
    _controlView.enableVideoRecord = _enableVideoRecord;
}
...
//        _controlView.enableVideoRecord = self.enableVideoRecord;
        ...
        _backBtn.center = CGPointMake(ScreenWidth/5, _controlView.centerY);
