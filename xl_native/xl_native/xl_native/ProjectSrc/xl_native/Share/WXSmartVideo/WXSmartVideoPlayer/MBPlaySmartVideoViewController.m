...
@interface MBPlaySmartVideoViewController ()<MBActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    self.item = [AVPlayerItem playerItemWithURL:[self urlValidation:self.videoUrlString]]; //支持网络播放和本地播放
    ...
    self.playerLayer.frame = self.videoView.bounds;//CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
