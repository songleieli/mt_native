...
- (void)setup {
    ...
    self.viewBg.size = [UIView getSize_width:ScreenWidth height:HomeSearchCellHeight];
    ...
    self.imageVeiwIcon.size = [UIView getSize_width:HomeSearchCellHeight/3*2 height:HomeSearchCellHeight/3*2];
