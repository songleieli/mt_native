...
@interface UserInfoPlayerCell : BaseTableViewCell<AVPlayerUpdateDelegate,SwitchPlayerMaskViewDelegate>

+ (NSString*) cellId;

@property(nonatomic, weak)id <UserInfoPlayerDelegate> homeDelegate;
