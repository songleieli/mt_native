...
static NSString* const ViewTableViewCellId = @"UserCollectionSubTopicCell";


@implementation UserCollectionSubTopicCell
...
- (void)fillDataWithModel:(GetTopicCollectionModel *)model{
