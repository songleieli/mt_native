...
- (void)setup {
    ...
    self.viewBg.size = [UIView getSize_width:ScreenWidth height:MusicHotSubMusicCellHeight];
    ...
    self.imageVeiwIcon.size = [UIView getSize_width:MusicHotSubMusicCellHeight/5*3
    ...
    self.lableuseCount.top = (MusicHotSubMusicCellHeight - self.lableuseCount.height)/2;
