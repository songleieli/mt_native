...
@interface ZjMaterialsSearcModel : IObjcJsonBase
...
@interface ZjMaterialsSearcTempModel : IObjcJsonBase
...
@interface ZjMaterialsSearcRespone : IObjcJsonBase

@property(nonatomic,copy) NSString *status_code;
@property(nonatomic,strong) ZjMaterialsSearcTempModel * result;
@property(nonatomic,copy) NSString *errmsg;

@end

@interface NetWork_ZJ_wm_materials_search : WCServiceBase_Zjsh
