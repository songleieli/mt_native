...
#import "NetWork_ZJ_meter_enter_log_post.h"

@implementation ZjMeterEnterLogCacheModel


@end

@implementation ZjMeterEnterLogPostostRespone
...
@implementation NetWork_ZJ_meter_enter_log_post
...
-(Class)responseType{
    return [ZjMeterEnterLogPostostRespone class];
}

-(NSString*)responseCategory{
    return @"/api/v1/umeter_enter_logs/meter_enter_log_post";
}
