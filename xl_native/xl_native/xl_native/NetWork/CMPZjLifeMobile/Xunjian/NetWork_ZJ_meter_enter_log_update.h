...
//@interface ZjMeterEnterLogCacheUpdateModel : IObjcJsonBase
//
...
@interface ZjMeterEnterLogUpdateRespone : IObjcJsonBase
...
@interface NetWork_ZJ_meter_enter_log_update : WCServiceBase_Zjsh
