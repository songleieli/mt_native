...
#define SPACE 10
@interface CZActionSheetView ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UIView *maskView;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *optionsArr;
@property (nonatomic,   copy) NSString *cancelTitle;
@property (nonatomic, strong) UIView *headView;
@property (nonatomic,   copy) IntegerBlock selectedBlock;
@property (nonatomic,   copy) VoidBlock cancelBlock;
@end
@implementation CZActionSheetView
...
//    [keywindow addSubview:cover];
    ...
    [UIView animateWithDuration:.5 animations:^{
        CGRect rect = weekSelf.tableView.frame;
        rect.origin.y -= weekSelf.tableView.bounds.size.height;
        weekSelf.tableView.frame = rect;
    }];
}
