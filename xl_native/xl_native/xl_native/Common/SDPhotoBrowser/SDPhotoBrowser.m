...
- (void)setupToolbars
{
    ...
    indexLabel.bounds = CGRectMake(0, KStatusBarHeight_New, 80, 40);
...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, 60);
    _saveButton.frame = CGRectMake(30, self.bounds.size.height - 70, 50, 25);
}

- (void)show
{
//    [GlobalFunc event:@"event_click_picture_from_market"];
