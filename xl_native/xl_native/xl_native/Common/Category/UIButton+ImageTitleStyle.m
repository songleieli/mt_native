...
//    [self setTitleColor:myapprovelable forState:(UIControlStateNormal)];
...
//    [self setBackgroundColor:[UIColor yellowColor]];
    ...
    //            [sender setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, sender.titleLabel.current_x, 0)];
    
    
    //myapprovelable
    
    
    [self setTitleEdgeInsets:UIEdgeInsetsMake(0, -15, self.titleLabel.frame.origin.y - 3, self.titleLabel.frame.origin.x )];
