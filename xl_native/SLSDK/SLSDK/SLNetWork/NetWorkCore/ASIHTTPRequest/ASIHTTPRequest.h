...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
    ...
    // Called on the delegate (if implemented) when the request cancelled. Default is requestCancelled:
    ...
    //block to execute when request cancelled
    ASIBasicBlock cancelBlock;
...
@property (assign) SEL cancelledSelector;
